...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            score, acc, evidence, format, pred_label, evid_cover, veri_acc, joint_acc = compute_score_fn(solution_str=sequences_str, ground_truth=ground_truth, format_score=self.format_score, challenge=challenge, data_source=data_source)
